...
def main():
    ...
    host_registry.init_tables()
    remote_bot_manager.init_tables()
    ...
    # ۲.۵ استارت سرورِ HTTPِ داخلی (host_api) که هاست‌های سلف باهاش صحبت
    # می‌کنن. حتماً باید بالا بیاد وگرنه هیچ هاست سلفی نمی‌تونه وصل بشه و
    # روی Render هم بدون پورتِ باز، سرویس Web Service سالم دیده نمی‌شه.
    from host_server import start_host_server_background
    start_host_server_background()
    print("✅ سرور داخلیِ host_api بالا اومد")
